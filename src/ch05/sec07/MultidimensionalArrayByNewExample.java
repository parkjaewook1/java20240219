...
public class MultidimensionalArrayByNewExample {
    public static void main(String[] args) {
        ...
        System.out.println();
        //배열 항목 값 변경
        mathScores[0][0] = 80;                      // 80 , 83 , 86
        mathScores[0][1] = 83;                      // 86 , 90 , 92
        mathScores[0][2] = 85;
        mathScores[1][0] = 86;
        mathScores[1][1] = 90;
        mathScores[1][2] = 92;
        ...
        totalStudent = 0;
        int totalEnlishSum = 0;
        for (int i = 0; i < englishScores.length; i++) {                // for (int[] englishClass : englishScores) {
            totalStudent += englishScores[i].length;
            for (int k = 0; k < englishScores[i].length; k++) {

                totalEnlishSum += englishScores[i][k];


            }

        }
        double totalEnglishAvg = (double) totalEnlishSum / totalStudent;
